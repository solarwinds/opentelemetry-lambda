...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/resourcedetectionprocessor v0.105.0 // indirect
	...
	github.com/solarwinds/apm-proto v1.0.5 // indirect
